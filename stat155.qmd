...
## Important Topics {.unnumbered}

In this course, we will build on the linear and logistic regression modeling techniques covered in STAT 155. 
As such, [**familiarity with key concepts from STAT 155 is expected**]{.text-primary}.
This includes, but is not necessarily limited to, the following topics:
...
## Review Resources {.unnumbered} 

### Quick Review {.unnumbered}     
...
### Comprehensive Review {.unnumbered} 

A comprehensive STAT 155 review is provided by the STAT 155 Notes created by
Profs. Grinde, Heggeseth, and Myint [(here)](https://mac-stat.github.io/Stat155Notes/) and Prof. Bill's Fall 25 STAT 155 website (skim the topics from the 'Activities' tab as needed!) [(here)](https://mutasim221b.github.io/Mac-STAT-155-Fall-25/).